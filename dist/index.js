...
app.get('/capture-screenshot', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const screenshotBuffer = yield captureScreenshot(htmlContent);
        if (screenshotBuffer) {
...
function captureScreenshot(htmlContent_1) {
    return __awaiter(this, arguments, void 0, function* (htmlContent, upperPartHeight = 250) {
        const browser = yield puppeteer.launch({
            args: ['--no-sandbox', '--disable-setuid-sandbox'],
        });
        const page = yield browser.newPage();
        try {
            yield page.setContent(htmlContent); // Set HTML content directly
